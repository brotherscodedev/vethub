...
import { FileText, Search, Plus, Dog, User, Calendar, Thermometer, Heart, Activity } from 'lucide-react';
...
export function MedicalRecords() {
  ...
  const filteredRecords = records.filter(
    (record) =>
      record.animal?.name.toLowerCase().includes(search.toLowerCase()) ||
      record.animal?.tutor?.name.toLowerCase().includes(search.toLowerCase()) ||
        ...
        {loading ? (
          ...
          <div className="text-center py-12">
            ...
            <p className="text-sm text-gray-400">
              {search ? 'Tente outra busca' : 'Comece criando o primeiro prontuário'}
            </p>
          </div>
        ) : (
          <div className="grid gap-4">
            {filteredRecords.map((record) => (
              ...
              >
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-2 text-sm text-gray-600">
                        ...
                        <span>Tutor: {record.animal?.tutor?.name || 'Não informado'}</span>
                      </div>
                    </div>
                  </div>
                ...
                {(record.temperature_celsius || record.heart_rate || record.weight_kg) && (
                ...
                {record.anamnesis && (
                  <div className="mb-3">
                    <p className="text-sm font-medium text-gray-700 mb-1">Anamnese:</p>
                    <p className="text-sm text-gray-600 line-clamp-2">{record.anamnesis}</p>
                  </div>
                )}
                ...
                {record.treatment_plan && (
                  <div>
                    <p className="text-sm font-medium text-gray-700 mb-1">Plano de Tratamento:</p>
          ...
          >
            ...
            >
              <div className="p-6 border-b">
                <h2 className="text-2xl font-bold text-gray-900">Detalhes do Prontuário</h2>
              </div>
              <div className="p-6 space-y-6">
                <div>
                  <h3 className="text-lg font-semibold mb-2">Informações do Animal</h3>
                  <div className="bg-gray-50 p-4 rounded-lg">
                    ...
                    <p>
                      <strong>Tutor:</strong> {selectedRecord.animal?.tutor?.name}
                    </p>
                  </div>
                </div>
                ...
                {selectedRecord.anamnesis && (
                  <div>
                    ...
                    <div className="bg-gray-50 p-4 rounded-lg">
                      <p className="whitespace-pre-wrap">{selectedRecord.anamnesis}</p>
                    </div>
                  </div>
                )}
                ...
                {selectedRecord.clinical_impression && (
                  <div>
                    <h3 className="text-lg font-semibold mb-2">Impressão Clínica</h3>
                    <div className="bg-gray-50 p-4 rounded-lg">
                ...
                <div className="text-sm text-gray-500 border-t pt-4">
                  <p>
                    <strong>Veterinário:</strong> Dr(a). {selectedRecord.veterinarian_name}
                  </p>
                  <p>
                    <strong>Data:</strong>{' '}
